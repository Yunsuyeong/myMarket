...
const ChatsDetail: NextPage = () => {
  return (
    <Layout canGoBack>
      ...
      <div className="space-y-3 px-2 py-8 sm:absolute sm:left-0 sm:right-0 sm:w-full">
        ...
        <form className="fixed inset-x-0 bottom-2 mx-auto w-full max-w-md sm:absolute sm:right-0 sm:-bottom-36 sm:w-2/3">
