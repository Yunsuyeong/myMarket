          ...
          >
            ...
            <div className="flex items-end justify-end space-x-2">
              <div className="text-sm">
                {item.registers.length !== 0 ? (
                  <svg
                    ...
                    strokeWidth="2"
                    stroke="currentColor"
                    className="relative bottom-[2px] h-4 w-4 rounded-full bg-green-700"
                  >
                    <path
                      strokeLinecap="round"
                  ...
                  <svg
                    ...
                    strokeWidth="2"
                    stroke="currentColor"
                    className="relative bottom-[2px] h-4 w-4 rounded-full bg-red-700"
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <div className="flex items-center space-x-1 text-sm">
                ...
                <span>{item.registers.length}</span>
              </div>
            </div>
          </div>
        ))}
